...
export default class NuCode extends NuElement {
  ...
  static get nuStyles() {
    return {
      ...
      text: 'monospace',
      '--com-color': 'hue(0 0 low) :special[hue(0 0 low special)]',
      ...
      '--mrk-color': 'hue(240 70 60) :special[hue(240 70 60 special)]',
      '--mrk-bg-color': 'hue(240 70 3) :special[hue(240 70 3 special)]',
