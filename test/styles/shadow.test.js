...
checkGenerator('shadow', shadowAttr, {
  '': { '--nu-local-depth-shadow': '0 0 1rem 0 rgba(var(--nu-shadow-color-rgb), .5)' },
  'y': { '--nu-local-depth-shadow': '0 0 1rem 0 rgba(var(--nu-shadow-color-rgb), .5)' },
  'n': { '--nu-local-depth-shadow': '0 0 0rem 0 rgba(var(--nu-shadow-color-rgb), .5)' },
  '1x': { '--nu-local-depth-shadow': '0 0 var(--nu-gap) 0 rgba(var(--nu-shadow-color-rgb), .5)' },
  '2x special': { '--nu-local-depth-shadow': '0 0 calc(2 * var(--nu-gap)) 0 rgba(var(--nu-special-shadow-color-rgb), 1)' },
